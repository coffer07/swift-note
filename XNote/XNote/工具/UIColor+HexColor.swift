...
extension UIColor {
    ...
    private convenience init(hex3: UInt16, alpha: CGFloat = 1.0) {
    ...
    private convenience init(hex4rgba: UInt16) {
    ...
    private convenience init(hex6: UInt32, alpha: CGFloat = 1.0) {
    ...
    private convenience init(hex8rgba: UInt32) {
    ...
    private convenience init(hex4argb: UInt16) {
    ...
    private convenience init(hex8argb: UInt32) {
    ...
    public convenience init?(hexColor: String, isRGBA: Bool = true) {
        ...
        if hexColor.hasPrefix("#") {
            let index = hexColor.index(hexColor.startIndex, offsetBy: 3)
